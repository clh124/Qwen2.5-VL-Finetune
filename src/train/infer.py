...
from src.dataset import make_supervised_data_module, SupervisedDataset_eval
...
def train():
    ...
    val_dataset = SupervisedDataset_eval(data_path=data_args.data_path, processor=processor, data_args=data_args, model_id=model_args.model_id)
    ...
    for item2 in val_dataloader:
        ...
        generated_ids_trimmed = [
            out_ids[ :] for in_ids, out_ids in zip(item["input_ids"], generated_ids)
            ]
