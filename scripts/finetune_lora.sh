...
MODEL_NAME="/fs-computility/ResearchEval/shared/hub/Qwen/Qwen2.5-VL-72B-Instruct"
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed src/train/train_sft.py \
    ...
    --output_dir /fs-computility/ResearchEval/shared/clh/testing_lora_qwen_72b_co_instruct3 \
    --num_train_epochs 1 \
